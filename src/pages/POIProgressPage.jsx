  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-[#FFF4D6] to-[#F6C468] p-6 pt-14">
      ...
      <button
        ...
        className="absolute top-4 left-4 flex items-center gap-2 text-marron-100 font-bold
                   bg-white/80 px-4 py-2 rounded-full shadow-md hover:bg-white transition"
      >
